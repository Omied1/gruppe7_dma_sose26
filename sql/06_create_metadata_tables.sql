...
CROSS JOIN (VALUES
    ...
    ('delay_minutes',  'INT',         'Tatsächliche Verzögerung in Minuten',             'delay_minutes',  'EVENTDATEN', 'RATIO',   '>= 0 (CHECK-Constraint). > 60 min = SLA-Verletzung (DWH-Schwellenwert). 0 = pünktlich. Skalentyp RATIO: 0 bedeutet ''keine Verzögerung'', Verhältnisse sinnvoll (120/60 = doppelte Verzögerung).', FALSE, FALSE, FALSE),
